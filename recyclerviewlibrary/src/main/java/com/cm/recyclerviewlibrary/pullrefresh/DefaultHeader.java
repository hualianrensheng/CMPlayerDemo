...
public class DefaultHeader extends BaseIndicator {
    ...
    private ProgressWheel progress_header_wheel;
    ...
    public View createView(LayoutInflater inflater, ViewGroup parent) {
        ...
        progress_header_wheel = (ProgressWheel) v.findViewById(R.id.progress_header_wheel);
        default_rim_color = progress_header_wheel.getRimColor();
        return child;
    }
    ...
    public void onRestore() {
        mStringIndicator.setText("下拉以刷新");
        progress_header_wheel.setRimColor(default_rim_color);
        progress_header_wheel.stopSpinning();
    }

    @Override
    public void onLoading() {
        mStringIndicator.setText("加载中...");
        progress_header_wheel.setRimColor(Color.parseColor("#00000000"));
        progress_header_wheel.spin();
    }
}
